...
import {
	OpenAIQueryMatchingUsersResponse,
	OpenAIQueryMatchingUsersSummaryResponse
} from './schema';
const getPromptMatchingContributorSummary = (
	query: string,
	profile: { location: string | null },
	repositories: { description: string; name: string; language: string | null; created_at: string }[]
) => {
	return `
...
const getPromptMatchingLinkedinProfileSummary = (
	query: string,
	description: string,
	location?: string
) => {
...
export const summarizeContributorMatch = async (
	queryTaskId: string,
	query: string,
	profile: { location: string | null },
	repositories: { description: string; name: string; language: string | null; created_at: string }[]
...
export const summarizeLinkedinMatch = async (
	queryTaskId: string,
	query: string,
	description: string,
	location?: string
